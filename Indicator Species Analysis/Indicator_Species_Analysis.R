...
isa_merged_phyloseq <- multipatt(t(otu_table(merged_phyloseq_genus_RA)), cluster = sample_data(merged_phyloseq_genus_RA)$`Combined`)
summary(isa_merged_phyloseq) #view results
...
final_table <- isa_merged_phyloseq$sign %>%
