##Functional analysis comparing e-cigarettes vs control in chinese samples -->  
...
ggsave("cn_ecigs_v_cont_results/Plots/KEGG Error Bar Fixed.png",
...
pheatmap(stats, 
         ...
         fontsize_row = 10, 
         fontsize_col = 10,
         filename = "cn_ecigs_v_cont_results/Plots/KEGG Heatmap.png",
         height= 9, width = 9)
...
ggsave("cn_ecigs_v_cont_results/Plots/Pathway_PCA.png", plot = p, width = 8, height = 6)
